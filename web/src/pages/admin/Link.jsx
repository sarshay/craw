...
function MyLink(props) {
    const { loading, error, data, setData, refresh } = useApi(API_ROUTES.LINK);
    ...
    return (
        <>
            ...
            <Table
                title={()=><Flex gap={8}><Button onClick={refresh} icon={<GrRefresh/>}/> <Button onClick={()=>setSelected({})}>Add New</Button></Flex>}
                loading={loading}
                rowClassName={(record) => {
